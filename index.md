...
The task runner [`duty`](https://github.com/pawamoy/duty) uses `failprint`, allowing you to define tasks in Python and run them with minimalist and beautiful output:

## Requirements

failprint requires Python 3.8 or above.

To install Python 3.8, I recommend using [`pyenv`](https://github.com/pyenv/pyenv).
